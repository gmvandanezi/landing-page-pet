  ...
  return (
    <section className="bg-[#E84c3d] py-16 text-white">
      <div className="container mx-auto px-4">
        ...
        <footer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12 mt-5 select-none">
          <div>
            ...
            <a
              ...
              className="bg-green-500 hover:bg-green-600 duration-300 px-4 py-2 rounded-md border border-gray-50"
            >
